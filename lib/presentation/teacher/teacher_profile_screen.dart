...
class _TeacherProfileScreenState extends State<TeacherProfileScreen> {
  ...
  void initState() {
    ...
    if (user != null) {
      ...
      selectedSubject = user.teacherSubject;
    }
  }
  ...
  Future<void> _saveProfile(
      BuildContext context, UserModel teacher) async {
    ...
    try {
      ...
      if (profileImage != null) {
        await context
            .read<UserViewModel>()
            .updateProfileImage(teacher.uid, profileImage);
      }
